...
public class InventorySceneOpener : MonoBehaviour, IPointerClickHandler
{
    // Bu fonksiyon, butona týklanýldýðýnda çalýþtýrýlacak
    public void OpenSettingsScene()
    {
        SceneManager.LoadScene("InventoryScene"); // "InventoryScene" sahne adýdýr, kendi sahne adýnýzý buraya yazýn
    }
